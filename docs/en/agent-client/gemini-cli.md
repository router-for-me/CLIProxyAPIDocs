...
For a practical macOS setup with a thin `.app` launcher, built-in Web UI, and a separate update workflow, see [macOS Local Launcher](/management/macos-local-launcher).
